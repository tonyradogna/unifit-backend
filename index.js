...
app.use(cors({
origin: [
“https://inquisitive-wisp-612937.netlify.app”,
“https://shopcampusfit.com”,
“https://www.shopcampusfit.com”,
“http://localhost:3000”,
],
methods: [“GET”, “POST”],
}));
...
// ── BODY PARSING ──
// Webhook route gets raw bytes (required for Stripe signature verification).
// All other routes get parsed JSON.
// NOTE: the webhook middleware must be declared before express.json() globally.
...
// Tank Top: Next Level 1533 Women’s Ideal Racerback Tank (product 857)
const TANK = {
“Black”:        { XS:22536, S:22541, M:22546, L:22551, XL:22556, “2XL”:22561 },
“White”:        { XS:22540, S:22545, M:22550, L:22555, XL:22560, “2XL”:22565 },
“Heather Gray”: { XS:22537, S:22542, M:22547, L:22552, XL:22557, “2XL”:22562 },
“Hot Pink”:     { XS:22538, S:22543, M:22548, L:22553, XL:22558, “2XL”:22563 },
“Tahiti Blue”:  { XS:22539, S:22544, M:22549, L:22554, XL:22559, “2XL”:22564 },
};

// Crop Top: All-Over Print Crop Top (product 200)
const CROP_TOP = {
...
const maps = {
“Unisex Tee”: {
“#000000”: “Black”,      “#ffffff”: “White”,     “#1a1a2e”: “Navy”,
“#5b2d8e”: “Team Purple”,”#c0a44a”: “Gold”,      “#ff6b6b”: “Red”,
“#808080”:  “Ash”,       “#fdf8f0”: “Soft Cream”,”#2e8b57”: “Forest”,
“#87ceeb”:  “Baby Blue”, “#ff69b4”: “Pink”,      “#800000”: “Maroon”,
},
“Women’s Tee”: {
“#000000”: “Black”,           “#ffffff”: “White”,              “#1a1a2e”: “Navy”,
“#ff69b4”: “Pink”,            “#b07080”: “Heather Mauve”,      “#808080”: “Athletic Heather”,
“#555555”: “Dark Grey Heather”,”#4a90d9”: “Heather Blue Lagoon”,”#c0392b”: “Heather Red”,
“#999999”: “Heather Stone”,   “#228b22”: “Leaf”,
},
“Hoodie”: {
“#000000”: “Black”,         “#ffffff”: “White”,          “#1a1a2e”: “Navy Blazer”,
“#5b2d8e”: “Purple”,        “#c0a44a”: “Team Gold”,      “#ff6b6b”: “Team Red”,
“#808080”: “Carbon Grey”,   “#fdf8f0”: “Oatmeal Heather”,”#2e8b57”: “Forest Green”,
“#87ceeb”: “Sky Blue”,      “#ff69b4”: “Light Pink”,     “#800000”: “Maroon”,
“#c17e80”: “Dusty Rose”,    “#4169e1”: “Team Royal”,     “#1a1a1a”: “Vintage Black”,
“#c8a2c8”: “Lavender”,      “#555555”: “Charcoal Heather”,
},
“Crewneck”: {
“#000000”: “Black”,  “#ffffff”: “White”,       “#1a1a2e”: “Navy”,
“#5b2d8e”: “Purple”, “#c0a44a”: “Gold”,        “#ff6b6b”: “Red”,
“#808080”: “Ash”,    “#d2b48c”: “Sand”,        “#800000”: “Maroon”,
“#228b22”: “Irish Green”,”#999999”: “Sport Grey”,
},
“Tank Top”: {
“#000000”: “Black”,       “#ffffff”: “White”,
“#808080”: “Heather Gray”,”#ff69b4”: “Hot Pink”,
“#52c7bd”: “Tahiti Blue”,
},
};
...
// Phone cases are not supported — return null so the webhook skips gracefully
if (product === “Phone Case”) return null;
...
// Best discount wins — bulk vs coupon, not stacked
let discountPercent = qty >= 10 ? 10 : 0;
...
console.log(`Variant lookup: product=${product} color=${garmentColor} size=${size} → variantId=${variantId}`);
...
try {
  ...
  if (data.code !== 200) {
    console.error("Printful returned non-200:", data.code, data.result);
  }
} catch (err) {
...
// Always respond 200 to Stripe so it doesn’t retry
res.json({ received: true });
});

// ── SESSION RETRIEVAL (for order confirmation page) ──
